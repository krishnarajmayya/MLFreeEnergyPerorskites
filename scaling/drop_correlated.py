...
df_dropped.to_csv('non_corelated_features.csv', index=False)
...
# Write the modified DataFrame to a new CSV file
Coeff_A.to_csv('Coeff_A.csv', index=False)
...
# Write the modified DataFrame to a new CSV file
Coeff_B.to_csv('Coeff_B.csv', index=False)
...
# Write the modified DataFrame to a new CSV file
Coeff_C.to_csv('Coeff_C.csv', index=False)
...
# Write the modified DataFrame to a new CSV file
Coeff_D.to_csv('Coeff_D.csv', index=False)