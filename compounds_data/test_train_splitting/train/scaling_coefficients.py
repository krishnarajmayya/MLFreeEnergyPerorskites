...
def scale_and_save_features(input_file, name_string):
    ...
    scaled_standard_features = pd.read_csv('scaled_standard_features_train.csv')
    scaled_minmax_features = pd.read_csv('scaled_minmax_features_train.csv')
    ...
    scaled_standard_df.to_csv(f"scaled_standard_{name_string}_train.csv", index=False)
    scaled_minmax_df.to_csv(f"scaled_minmax_{name_string}_train.csv", index=False)



scale_and_save_features('train_Coeff_A.csv', 'Coeff_A')
scale_and_save_features('train_Coeff_B.csv', 'Coeff_B')
scale_and_save_features('train_Coeff_C.csv', 'Coeff_C')
scale_and_save_features('train_Coeff_D.csv', 'Coeff_D')
