...
df_dropped.to_csv('train_features.csv', index=False)
...
# Write the modified DataFrame to a new CSV file
Coeff_A.to_csv('train_Coeff_A.csv', index=False)
...
# Write the modified DataFrame to a new CSV file
Coeff_B.to_csv('train_Coeff_B.csv', index=False)
...
# Write the modified DataFrame to a new CSV file
Coeff_C.to_csv('train_Coeff_C.csv', index=False)
...
# Write the modified DataFrame to a new CSV file
Coeff_D.to_csv('train_Coeff_D.csv', index=False)