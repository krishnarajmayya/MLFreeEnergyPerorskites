...
scaled_standard_features.to_csv('scaled_standard_features_test.csv',index=False)
scaled_minmax_features.to_csv('scaled_minmax_features_test.csv',index=False)